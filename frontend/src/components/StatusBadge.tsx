...
export type StatusBadgeProps = {
  ...
  label?: string;
  /**
   * «documents» — подписи для списка «Мои документы» (черновик, проверка, регистрация, передача).
...
/** Подписи для вкладки «Мои документы» + карточка документа / загрузка в том же контексте. */
